...
#     print(a / b)  
#########################################
# c = lambda func: lambda a, b: func(a, b) if b != 0 else "Xato: Nomi bo'yicha 0 ga bo'linish mumkin emas!"
# d = c(lambda a, b: a / b)
# r = d(6, 2)
# print(r)  
# rz = d(6, 0)
# print(rz)  
#########################################
# c = lambda func: lambda a, b: func(a, b) if b != 0 else "Denominator can't be zero"
# d = c(lambda a, b: a / b)
# r = d(6, 2)
# print(r)  
# rz = d(6, 0)
